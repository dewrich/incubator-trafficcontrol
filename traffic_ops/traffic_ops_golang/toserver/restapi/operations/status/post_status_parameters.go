...
// PostStatusParams contains all the bound params for the post status operation
...
func (o *PostStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
