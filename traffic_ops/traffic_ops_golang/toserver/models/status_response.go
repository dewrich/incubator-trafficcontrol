...
// StatusResponse A Single Status Response for Update and Create to depict what changed
// swagger:model StatusResponse
type StatusResponse struct {

	// response
	Response *Status `json:"response,omitempty"`
}
...
func (m *StatusResponse) validateResponse(formats strfmt.Registry) error {
