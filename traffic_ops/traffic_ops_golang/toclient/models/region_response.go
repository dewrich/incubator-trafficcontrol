...
// RegionResponse A Single Region Response for Update and Create to depict what changed
// swagger:model RegionResponse
type RegionResponse struct {

	// response
	Response *Region `json:"response,omitempty"`
}
...
func (m *RegionResponse) validateResponse(formats strfmt.Registry) error {
