...
type StatComputeFunc func(resultInfo ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{}
...
func ComputedStats() map[string]StatComputeFunc {
	return map[string]StatComputeFunc{
		"availableBandwidthInKbps": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.Vitals.MaxKbpsOut - info.Vitals.KbpsOut
		},

		"availableBandwidthInMbps": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return (info.Vitals.MaxKbpsOut - info.Vitals.KbpsOut) / 1000
		},
		"bandwidth": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.Vitals.KbpsOut
		},
		"error-string": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			if info.Error != nil {
				return info.Error.Error()
			}
			return "false"
		},
		"isAvailable": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return combinedState.IsAvailable // if the cache is missing, default to false
		},
		"isHealthy": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			if enum.CacheStatusFromString(serverInfo.Status) == enum.CacheStatusAdminDown {
				return true
			}
			return combinedState.IsAvailable
		},
		"kbps": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.Vitals.KbpsOut
		},
		"loadavg": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.Vitals.LoadAvg
		},
		"maxKbps": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.Vitals.MaxKbpsOut
		},
		"queryTime": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.RequestTime.Nanoseconds() / nsPerMs
		},
		"stateUrl": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return serverProfile.Parameters.HealthPollingURL
		},
		"status": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return serverInfo.Status
		},
		"system.astatsLoad": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.AstatsLoad
		},
		"system.configReloadRequests": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.ConfigLoadRequest
		},
		"system.configReloads": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.ConfigReloads
		},
		"system.inf.name": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.InfName
		},
		"system.inf.speed": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.InfSpeed
		},
		"system.lastReload": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.LastReload
		},
		"system.lastReloadRequest": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.LastReloadRequest
		},
		"system.notAvailable": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.NotAvailable
		},
		"system.proc.loadavg": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
			return info.System.ProcLoadavg
		},
		"system.proc.net.dev": func(info ResultInfo, serverInfo toapi.TrafficServer, serverProfile toapi.TMProfile, combinedState peer.IsAvailable) interface{} {
...
func StatsMarshall(statResultHistory ResultStatHistory, statInfo ResultInfoHistory, combinedStates peer.Crstates, monitorConfig toapi.TrafficMonitorConfigMap, statMaxKbpses Kbpses, filter Filter, params url.Values) ([]byte, error) {
	stats := Stats{
